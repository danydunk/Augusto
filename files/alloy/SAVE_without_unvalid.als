...
pred click_success_post [aw: Action_widget, t, t': Time] {
	Current_window.is_in.t' = aws.New => #Input_widget.content.t' = 0 and #Opening_list.selected.t' = 0 else all iw:  Input_widget | iw.content.t' = iw.content.t and Opening_list.selected.t' = Opening_list.selected.t and Opening_list.list.t' = Opening_list.list.t
