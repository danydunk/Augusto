...
import resources.test.rft.Option_widget_testHelper;
 ...
 * @author usi
 */
public class Option_widget_test extends Option_widget_testHelper {

	/**
	 * Script Name : <b>Option_widget_test</b> Generated : <b>Dec 7, 2016
	 * 2:54:16 PM</b> Description : Functional Test Script Original Host : WinNT
	...
	public void testMain(final Object[] args) throws Exception {
		...
		final String run2 = "run{System and (one t:Time,  f: Fill |  Track.op.t = f and not(f.with = Input_widget_iw20.content.(T/first)) and  #f.with = 1 and f.filled = Input_widget_iw20)} for 8";
