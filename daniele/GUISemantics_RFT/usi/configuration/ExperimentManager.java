	...
	public static void init() throws Exception {
		...
		String args[] = {
				...
				"lib" + System.getProperty("file.separator") + "cobertura" + System.getProperty("file.separator")
						+ "cobertura.ser", ConfigurationManager.getAutBinDirectory(), };
		...
		try {
			...
			out.newLine();
			out.write("java -Xbootclasspath/p:" + System.getProperty("user.dir") + System.getProperty("file.separator")
					+ "lib" + System.getProperty("file.separator") + "abtJFileChooser.jar;" + " -cp %CLASSPATH%;"
					+ System.getProperty("user.dir") + File.separator + "bin;" + System.getProperty("user.dir")
					...
					+ "lib" + System.getProperty("file.separator") + "jmockit" + System.getProperty("file.separator")
					+ "jmockit.jar" + ";" + " -javaagent:" + System.getProperty("user.dir") + File.separator + "lib"
					...
					+ File.separator + "lib" + System.getProperty("file.separator") + "cobertura"
					+ System.getProperty("file.separator") + "cobertura.ser\"" + " " + "usi.rmi.AUTMain" + " "
					+ ConfigurationManager.getAutMainCLass() + " 1> \"" + System.getProperty("user.dir")
