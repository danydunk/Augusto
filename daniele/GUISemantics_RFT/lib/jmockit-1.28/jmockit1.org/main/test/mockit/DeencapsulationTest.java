...
public final class DeencapsulationTest
{
   ...
   @Test
   public void attemptToInvokeInstanceMethodFromExpectationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("expectation");

      new Expectations() {{
         invoke(anInstance, "aMethod");
      }};
   }

   @Test
   public void attemptToInvokeStaticMethodWithGivenParameterTypesFromExpectationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("expectation");
      ...
      new Expectations() {{
         ...
         invoke(Subclass.class, "staticMethod", parameterTypes, (short) 1, "", true);
      }};
   }

   @Test
   public void attemptToInvokeMethodFromVerificationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("verification");

      new Verifications() {{
         invoke(Subclass.class, "anStaticMethod");
      }};
   }

   @Test
   public void attemptToInvokeConstructorFromExpectationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("expectation");

      new Expectations() {{
         newInstance(Subclass.class);
      }};
   }

   @Test
   public void attemptToInvokeConstructorWithGivenParameterTypesFromVerificationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("verification");
      ...
      new FullVerifications() {{
         ...
         newInstance(Subclass.class, parameterTypes, 1, "");
      }};
   }

   @Test
   public void attemptToInvokeConstructorWithGivenClassNameFromVerificationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("verification");

      new Verifications() {{
         newInstance(Subclass.class.getName());
      }};
   }

   @Test
   public void attemptToInvokeConstructorWithGivenClassNameAndParameterTypesFromVerificationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("verification");
      ...
      new VerificationsInOrder() {{
         Class<?>[] parameterTypes = {int.class, String.class};
         newInstance(Subclass.class.getName(), parameterTypes, 1, "");
      }};
   }

   @Test
   public void attemptToInvokeInnerClassConstructorFromExpectationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("expectation");

      new StrictExpectations() {{
         newInnerInstance(Subclass.InnerClass.class, anInstance);
      }};
   }

   @Test
   public void attemptToInvokeInnerClassConstructorUsingSimpleClassNameFromVerificationBlock()
   {
      thrown.expect(IllegalArgumentException.class);
      thrown.expectMessage("verification");
