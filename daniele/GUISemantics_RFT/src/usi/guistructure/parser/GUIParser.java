package usi.guistructure.parser;
...
public class GUIParser {
	...
	private void createEdge(final Node node, final GUI gui) throws Exception {
		...
		final List<Action_widget> aw = gui.getAction_widgets().stream().filter(e -> e.getId().equals(idFrom))
	 ...
	 * @throws Exception
	 */
	private List<Selectable_widget> createSelectableWidgets(final Node nodeContainer) throws Exception {
