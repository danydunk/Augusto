package test.guisemantic.testcase;
...
public class GUIRippingTestCaseRunnerTest {
	...
	public void test() {
		...
		try {
			...
			final Document doc = XMLUtil.read(new File("./files/for_test/xml/upm-small.xml").getAbsolutePath());
			...
			final GUIRippingTestCaseRunner runner = new GUIRippingTestCaseRunner("./files/for_test",
					...
					"com._17od.upm.gui.MainWindow", "./files/for_test/xml/guiripping-upmsmall-EFG.xml",
