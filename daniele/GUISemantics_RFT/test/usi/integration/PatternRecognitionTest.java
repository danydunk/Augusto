...
public class PatternRecognitionTest {
	...
	public void test1() {
		...
		try {
			...
			Document doc = XMLUtil.read(new File("./resources/xml/add_pattern.xml").getAbsolutePath());
			final GUI_Pattern pattern = GUIPatternParser.parse(doc);

			// we load the GUI structure
			doc = XMLUtil.read(new File("./resources/for_test/xml/upm-small.xml").getAbsolutePath());
	...
	public void test2() {
		...
		try {
			final Document g = XMLUtil
					.read(new File("./resources/for_test/xml/guiripping-upmfull-GUI.xml").getAbsolutePath());
			final Document efg = XMLUtil
					.read(new File("./resources/for_test/xml/guiripping-upmfull-EFG.xml").getAbsolutePath());
			...
			final Document out = c.convert(inputs);
			// we save the GUI model
			XMLUtil.save("./resources/for_test/xml/upm-full.xml", out);
			...
			// we load the GUI structure
			doc = XMLUtil.read(new File("./resources/for_test/xml/upm-full.xml").getAbsolutePath());
			final GUI gui = GUIParser.parse(doc);
	...
	public void test3() {
		...
		try {
			final Document g = XMLUtil
					.read(new File("./resources/for_test/xml/guiripping-buddi-GUI.xml").getAbsolutePath());
			final Document efg = XMLUtil
					.read(new File("./resources/for_test/xml/guiripping-buddi-EFG.xml").getAbsolutePath());
			...
			final Document out = c.convert(inputs);
			// we save the GUI model
			XMLUtil.save("./resources/for_test/xml/buddi.xml", out);
			...
			// we load the GUI structure
			doc = XMLUtil.read(new File("./resources/for_test/xml/buddi.xml").getAbsolutePath());
			final GUI gui = GUIParser.parse(doc);
	...
	public void test1_labelfree() {
		...
		try {
			...
			// we load a gui pattern
			Document doc = XMLUtil.read(new File("./resources/xml/add_pattern_labelfree.xml").getAbsolutePath());
			final GUI_Pattern pattern = GUIPatternParser.parse(doc);
